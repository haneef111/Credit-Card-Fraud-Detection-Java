...
The model will be trained on a dataset of historical credit card transactions and evaluated on a holdout dataset of unseen transactions.
...
and**I Mentioned the dataset in the repository itself.**
